...
public class ForStmt implements Stmt {
    ...
    public boolean equals(Object obj) {
        if(obj instanceof ForStmt stmt) {
            if(stmt.getIteratorExp().equals(iteratorExp) && stmt.getBlockStmt().equals(blockStmt)) {
                if(stmt.getArrayExp() != null && arrayExp != null && stmt.getArrayExp().equals(arrayExp)) {
                    return true;
                } else if(stmt.getRangeExp() != null && rangeExp != null && stmt.getRangeExp().equals(rangeExp)) {
                    if((stmt.getStepExp() != null && stepExp != null && stmt.getStepExp().equals(stepExp)) ||
                            (stmt.getStepExp() == null && stepExp == null)) {
                        return true;
                    }
                }
            }
